      ...
      {stats && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 text-center">
            ...
            <p className="text-white font-bold text-2xl">{stats.fixtures.played.total}</p>
          </div>
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 text-center">
            <p className="text-gray-400 text-xs mb-1">Victorias</p>
            <p className="text-green-400 font-bold text-2xl">{stats.fixtures.wins.total}</p>
          </div>
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 text-center">
            <p className="text-gray-400 text-xs mb-1">Goles anotados</p>
            <p className="text-white font-bold text-2xl">{stats.goals.for.total.total}</p>
          </div>
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 text-center">
            <p className="text-gray-400 text-xs mb-1">Goles recibidos</p>
            <p className="text-red-400 font-bold text-2xl">{stats.goals.against.total.total}</p>
          </div>
        </div>
      )}
